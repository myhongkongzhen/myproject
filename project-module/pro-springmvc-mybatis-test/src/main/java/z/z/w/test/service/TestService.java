...
public class TestService
{
	...
	public int addUser( TbTestUser testUser )
	{
		logger.debug( "add user..." );
		return testMapper.insert( testUser );
	}
	...
	public List< TbTestUser > queryUsersByParam( Map< String, Integer > map )
	{
		return testMapper.queryByParam( map );
	}
